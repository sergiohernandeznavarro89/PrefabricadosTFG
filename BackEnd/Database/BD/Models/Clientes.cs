...
namespace Database.BD.Models
{
    public class Clientes
    {
        ...
        public string Horma { get; set; } //Relacion con tabla Hormas (1 cliente N hormas : 1 horma 1 cliente)        
        public string TroquelesPropios { get; set; } //Relacion con tabla Troqueles (1 cliente 0-N Troqueles propios : 1 Troquel 0-1 cliente)        
        public string Escandallos { get; set; } //relación con la tabla Escandallo (1 Cliente N Escandallos : 1 Escandallo 1 Cliente)
